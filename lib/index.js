...
var SuperSelect = /*#__PURE__*/function (_PureComponent) {
  ...
  function SuperSelect(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "preventEvent", function (e) {
      e.preventDefault();
    });
  ...
  (0, _createClass2["default"])(SuperSelect, [{
      ...
      if (prevProps.children !== children) {
        ...
        this.setState({
          ...
          if (arr && arr.length > 0) {
            ...
            if (!value) {
              _this3.scrollTop = 0;
              _this3.scrollEle && _this3.scrollEle.scrollTo(0, 0);
              _this3.setSuperDrowDownMenu(true);
            }
            _this3.formulaWidth();
            _this3.removeEvent();
            _this3.addEvent();
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_select["default"], (0, _extends2["default"])({}, _props, {
        id: this.id,
